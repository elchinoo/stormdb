// Package main implements a specialized workload for measuring
...
// 1. Persistent connections: Reuse a pool of long-lived connections
// 2. Transient connections: Create and close connections for each transaction
//
