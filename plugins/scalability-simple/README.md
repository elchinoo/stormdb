# Scalability Simple Plugin

A simple TPC-C inspired scalability testing plugin for StormDB v2. This plugin performs incremental connection testing with a basic warehouse schema to measure database performance characteristics.PC-C Scalability Plugin for StormDB v2
